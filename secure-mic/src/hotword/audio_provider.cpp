...
TfLiteStatus InitAudioRecording(tflite::ErrorReporter* error_reporter) {
	...
	PDM.onReceive(captureHotwordSamples);
...
TfLiteStatus GetAudioSamples(tflite::ErrorReporter* error_reporter, int start_ms, int duration_ms,
	...
	// if (g_is_audio_initialized) TF_LITE_REPORT_ERROR(error_reporter, "g_is_audio_initialized = true");
	// else TF_LITE_REPORT_ERROR(error_reporter, "g_is_audio_initialized = false");
